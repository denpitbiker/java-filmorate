...
public class UserServiceTest {
    ...
    @BeforeEach
    public void setUp() {
        userId1 = service.addUser(TestStubs.VALID_USER_DTO_1.clone()).getId();
        userId2 = service.addUser(TestStubs.VALID_USER_DTO_2.clone()).getId();
    }
    ...
    public void addFriend_validUsers_friendAdded() {
        ...
        Collection<UserDto> userFriends = service.getUserFriends(userId1);
    ...
    public void getUserFriends_validUser_friendsReturned() {
        ...
        Collection<UserDto> userFriends = Assertions.assertDoesNotThrow(
    ...
    public void getCommonFriends_validUsers_commonFriendsReturned() {
        Long userId3 = service.addUser(VALID_USER_DTO_3).getId();
        service.addFriend(userId1, userId3);
        service.addFriend(userId2, userId3);

        Collection<UserDto> commonFriends = Assertions.assertDoesNotThrow(
    ...
    public void addUser_addNewUser_userAddedNoExceptions() {
        Assertions.assertDoesNotThrow(
                () -> service.addUser(VALID_USER_DTO_1.clone()),
    ...
    public void addUser_addDuplicateUser_throwDuplicatedDataException() {
        UserDto user = service.addUser(VALID_USER_DTO_1.clone());
        Assertions.assertThrows(
    ...
    public void updateUser_updateExistingUser_userUpdatedNoExceptions() {
        UserDto userToUpdate = service.addUser(VALID_USER_DTO_1.clone());
    ...
    public void updateUser_updateNonExistingUser_throwNotFoundException() {
        Assertions.assertThrows(
                NotFoundException.class,
                () -> service.updateUser(VALID_USER_DTO_1.clone()),
                NOT_FOUND_USER_FAIL_MSG
        );
    }
}
