...
public class UserControllerTest {
        ...
        public void get_userFriends_existingUser_success200() throws Exception {
                ...
                mvc.perform(put(UserController.CONTROLLER_ROUTE + UserController.ADD_FRIEND_SUBROUTE, userId1,
                                userId2));
        ...
        public void get_userFriends_nonExistingUser_notFound404() throws Exception {
                ...
                mvc.perform(put(UserController.CONTROLLER_ROUTE + UserController.ADD_FRIEND_SUBROUTE, userId1,
                                userId2));
                mvc.perform(get(UserController.CONTROLLER_ROUTE + UserController.GET_FRIENDS_SUBROUTE,
        ...
        public void get_usersCommonFriends_existingBothUsers_success200() throws Exception {
                ...
                mvc.perform(put(UserController.CONTROLLER_ROUTE + UserController.ADD_FRIEND_SUBROUTE, userId1,
                                userId3));
                mvc.perform(put(UserController.CONTROLLER_ROUTE + UserController.ADD_FRIEND_SUBROUTE, userId2,
                                userId3));
                mvc.perform(get(UserController.CONTROLLER_ROUTE + UserController.GET_COMMON_FRIENDS_SUBROUTE, userId1,
                                userId2))
                                .andExpect(status().isOk())
                                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON));
        }
        ...
        public void get_usersCommonFriends_onlySecondUserExists_notFound404() throws Exception {
                ...
                mvc.perform(put(UserController.CONTROLLER_ROUTE + UserController.ADD_FRIEND_SUBROUTE, userId2,
                                userId3));
                mvc.perform(get(UserController.CONTROLLER_ROUTE + UserController.GET_COMMON_FRIENDS_SUBROUTE,
                                TestStubs.NON_EXISTING_ID, userId2))
                                .andExpect(status().isNotFound());
        }
        ...
        public void delete_removeFriend_existingFriendAndUser_success200() throws Exception {
                ...
                mvc.perform(put(UserController.CONTROLLER_ROUTE + UserController.ADD_FRIEND_SUBROUTE, userId1,
                                userId2));
                mvc.perform(delete(UserController.CONTROLLER_ROUTE + UserController.REMOVE_FRIEND_SUBROUTE, userId1,
                                userId2))
                                .andExpect(status().isOk());
        }
        ...
        public void delete_removeFriend_existingFriendNonExistingUser_notFound404() throws Exception {
                ...
                mvc.perform(put(UserController.CONTROLLER_ROUTE + UserController.ADD_FRIEND_SUBROUTE, userId1,
                                userId2));
                mvc.perform(delete(UserController.CONTROLLER_ROUTE + UserController.REMOVE_FRIEND_SUBROUTE,
                                TestStubs.NON_EXISTING_ID, userId2))
                                .andExpect(status().isNotFound());
        }
        ...
        public void put_addFriend_existingFriendNonExistingUser_notFound404() throws Exception {
                Long userId1 = extractUserDto(addUser(TestStubs.VALID_USER_DTO_1.clone())).getId();
                mvc.perform(put(UserController.CONTROLLER_ROUTE + UserController.ADD_FRIEND_SUBROUTE,
                                TestStubs.NON_EXISTING_ID, userId1))
                                .andExpect(status().isNotFound());
        }
        ...
        public void get_user_invalidId_notFound404() throws Exception {
                ...
                mvc.perform(get(UserController.CONTROLLER_ROUTE + UserController.GET_USER_SUBROUTE,
                                TestStubs.NON_EXISTING_ID))
                                .andExpect(status().isNotFound());
        }
        ...
        public void delete_user_invalidId_notFound404() throws Exception {
                addUser(TestStubs.VALID_USER_DTO_1.clone());
                mvc.perform(delete(UserController.CONTROLLER_ROUTE + UserController.GET_USER_SUBROUTE,
                                TestStubs.NON_EXISTING_ID))
                                .andExpect(status().isNotFound());
        }
