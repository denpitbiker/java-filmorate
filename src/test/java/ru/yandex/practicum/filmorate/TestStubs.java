...
public class TestStubs {
    ...
    public static final Film VALID_FILM_1 = new Film(null, VALID_FILM_NAME_1, VALID_FILM_DESCRIPTION_1, VALID_DATE_1, VALID_DURATION_1, new HashSet<>());
    public static final Film VALID_FILM_2 = new Film(null, VALID_FILM_NAME_2, VALID_FILM_DESCRIPTION_2, VALID_DATE_2, VALID_DURATION_2, new HashSet<>());

    public static final Film INVALID_FILM_NULL_NAME = new Film(null, null, VALID_FILM_DESCRIPTION_2, VALID_DATE_1, VALID_DURATION_2, new HashSet<>());
    public static final Film INVALID_FILM_NULL_DESCRIPTION = new Film(null, VALID_FILM_NAME_1, null, VALID_DATE_1, VALID_DURATION_1, new HashSet<>());
    public static final Film INVALID_FILM_BLANK_DESCRIPTION = new Film(null, VALID_FILM_NAME_1, INVALID_FILM_DESCRIPTION_BLANK, VALID_DATE_1, VALID_DURATION_1, new HashSet<>());
    public static final Film INVALID_FILM_NULL_DATE = new Film(null, VALID_FILM_NAME_1, VALID_FILM_DESCRIPTION_1, null, VALID_DURATION_1, new HashSet<>());
    public static final Film INVALID_FILM_NULL_DURATION = new Film(null, VALID_FILM_NAME_1, VALID_FILM_DESCRIPTION_1, VALID_DATE_1, null, new HashSet<>());
    public static final Film INVALID_FILM_TOO_LONG_DESCRIPTION = new Film(null, VALID_FILM_NAME_1, INVALID_FILM_DESCRIPTION_TOO_LONG, VALID_DATE_1, VALID_DURATION_2, new HashSet<>());
    public static final Film INVALID_FILM_TOO_OLD_DATE = new Film(null, VALID_FILM_NAME_1, VALID_FILM_DESCRIPTION_1, TOOL_OLD_DATE, VALID_DURATION_2, new HashSet<>());
    public static final Film INVALID_FILM_DURATION_ZERO = new Film(null, VALID_FILM_NAME_1, VALID_FILM_DESCRIPTION_1, VALID_DATE_1, INVALID_DURATION_ZERO, new HashSet<>());
    public static final Film INVALID_FILM_NEGATIVE_DURATION = new Film(null, VALID_FILM_NAME_1, VALID_FILM_DESCRIPTION_1, VALID_DATE_1, INVALID_DURATION_NEGATIVE, new HashSet<>());
